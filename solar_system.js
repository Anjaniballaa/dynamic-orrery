...
function displayComets(comets) {
    comets.forEach(comet => {
        ...
        cometMesh.position.set(Math.random() * 10, Math.random() * 10, Math.random() * 10); 
...
const planets = [
    ...
    },
    {
        ...
        moons: [
            generateMoon(1.6362, earth_moonTexture, 68,6,-6) 
        ],  
    ...
    },
    {
        ...
        moons: [
            generateMoon(1.056, mars_PhobosTexture, 83,6,3), 
            generateMoon(0.5844, mars_DeimosTexture, 74,3,3) 
        ],
    },
    {
